...
private partial def proveStrictUpperBoundWithSubdiv
  ...
  -- Build the check expression
  let checkExpr ← mkAppM ``LeanBound.Numerics.Certificate.checkStrictUpperBound
    #[ast, intervalRat, boundRat, cfgExpr]
  ...
  if ← certCheckSucceeds checkExpr then
    ...
    let proof ← mkAppM ``Certificate.verify_strict_upper_bound_Icc_core
      #[ast, supportProof, loRatExpr, hiRatExpr, leProof, boundRat, cfgExpr, certProof]
    return some proof
  ...
  let leftCheckExpr ← mkAppM ``LeanBound.Numerics.Certificate.checkStrictUpperBound
    #[ast, leftInterval, boundRat, cfgExpr]
  let rightCheckExpr ← mkAppM ``LeanBound.Numerics.Certificate.checkStrictUpperBound
    #[ast, rightInterval, boundRat, cfgExpr]
  ...
  let proof ← mkAppM ``Certificate.verify_strict_upper_bound_general_split
    #[ast, supportProof, loRatExpr, midExpr, hiRatExpr,
      loLeMidExpr, midLeHiExpr, leProof, boundRat, cfgExpr,
      leftCertProof, rightCertProof]
...
private partial def proveStrictLowerBoundWithSubdiv
  ...
  -- Build the check expression
  let checkExpr ← mkAppM ``LeanBound.Numerics.Certificate.checkStrictLowerBound
    #[ast, intervalRat, boundRat, cfgExpr]
  ...
  if ← certCheckSucceeds checkExpr then
    ...
    let proof ← mkAppM ``Certificate.verify_strict_lower_bound_Icc_core
      #[ast, supportProof, loRatExpr, hiRatExpr, leProof, boundRat, cfgExpr, certProof]
    return some proof
  ...
  let leftCheckExpr ← mkAppM ``LeanBound.Numerics.Certificate.checkStrictLowerBound
    #[ast, leftInterval, boundRat, cfgExpr]
  let rightCheckExpr ← mkAppM ``LeanBound.Numerics.Certificate.checkStrictLowerBound
    #[ast, rightInterval, boundRat, cfgExpr]
  ...
  let proof ← mkAppM ``Certificate.verify_strict_lower_bound_general_split
    #[ast, supportProof, loRatExpr, midExpr, hiRatExpr,
      loLeMidExpr, midLeHiExpr, leProof, boundRat, cfgExpr,
      leftCertProof, rightCertProof]
